package it.mmo.campaigntracker;

import it.mmo.campaigntracker.calendar.CalendarFragment;
...
public class Tracker extends Activity implements ActionBar.TabListener {
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			case 1:
				return getString(R.string.title_cal).toUpperCase(l);
			case 2:
				return getString(R.string.title_candidates).toUpperCase(l);
			case 3:
